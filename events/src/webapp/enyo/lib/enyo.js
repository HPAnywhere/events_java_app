...
enyo.path.addPaths({layout: "C://HP/workspace/events-old/src/webapp/enyo/tools/../../lib/layout/", utils: "C://HP/workspace/events-old/src/webapp/enyo/tools/../../lib/utils/"});
...
enyo.kind({
name: "utils.RestService",
kind: "Component",
events: {
onShowMask: "",
onHideMask: ""
},
disableCaching: function(e) {
return encodeURI(e);
},
getMethod: function(e, t, n) {
!e || (new enyo.Ajax({
receive: function(e, t) {
!this.failed && !this.destroyed && (this.isFailure(t) ? (this.failed = !0, this.handle(t, this.errorHandlers), this.fail(t)) : this.respond(this.xhrToResponse(t)));
},
url: this.disableCaching(e),
headers: {
clientVer: "1.1.4",
"X-CSRF-HPMEAP": "events"
}
})).go().response(t).error(n);
},
postMethod: function(e, t, n, r) {
!e || (new enyo.Ajax({
url: this.disableCaching(e),
headers: {
clientVer: "1.1.4",
...
postBody: enyo.json.stringify(t)
})).go().response(n).error(r);
},
updateMethod: function(e, t, n, r) {
!e || (new enyo.Ajax({
url: this.disableCaching(e),
headers: {
clientVer: "1.1.4",
